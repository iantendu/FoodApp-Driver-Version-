...
class DashboardActivity : BaseActivity() {
    ...
    override fun InitView() {
        ...
        if (getStringPref(this@DashboardActivity, SharePreference.SELECTED_LANGUAGE).equals(resources.getString(R.string.language_hindi))) {
            ivHome.rotation = 180F
            ivOrderHistory.rotation = 180F
            ivSetting.rotation = 180F
            ivLogout.rotation = 180F
        } else {
            ivHome.rotation = 0F
            ivOrderHistory.rotation = 0F
            ivSetting.rotation = 0F
            ivLogout.rotation = 0F
        }
    }
